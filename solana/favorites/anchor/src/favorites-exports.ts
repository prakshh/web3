...
export function getFavoritesProgram(provider: AnchorProvider, address?: PublicKey) {
  return new Program({ ...FavoritesIDL, address: address ? address.toBase58() : FavoritesIDL.address } as Favorites, provider)
}
